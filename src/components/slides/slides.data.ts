...
export const SLIDES: readonly Slide[] = [
  ...
  },
  {
    ...
    columns: ["Gleam.io", "Galxe", "Raffle dApps", PRODUCT_NAME],
    rows: [
      { label: "Multi-platform actions", cells: ["yes", "yes", "no", "yes"] },
      { label: "Verified engagement", cells: ["partial", "partial", "no", "yes"] },
      { label: "Prize locked before entry", cells: ["no", "no", "partial", "yes"] },
      { label: "Auditable draw", cells: ["no", "no", "yes", "yes"] },
      { label: "Public payout trail", cells: ["no", "yes", "yes", "yes"] },
      { label: "Winners paid automatically", cells: ["no", "no", "partial", "yes"] },
    ],
  },
  {
    id: "slide-08",
