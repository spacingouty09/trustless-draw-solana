...
async function normalizeCatastrophicSsrResponse(response: Response, url: URL): Promise<Response> {
...
export default {
  async fetch(request: Request, env: unknown, ctx: unknown) {
    try {
      ...
      const debug = url.searchParams.has("__ssr_debug") ? buildDebugComment(error, "") : "";
